...
public class MySQLRecipeTests
{
    ...
    @Test
    public void aggregateQuery_ValidSingleAggregateAndQuery_ReturnsCorrectAggregate()
    {
    ...
    @Test
    public void aggregateQuery_SingleAggregateWithEmptyChildLists_ReturnsAggregateWithEmptyChildLists()
    {
        photon.registerAggregate(Recipe.class)
            .withId("recipeId")
            .withChild(RecipeInstruction.class)
